                    ...
                    <div class="primary-content">
                        <section>
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li class="active"><a data-toggle="tab" href="#menu1" >Favicon Images</a></li>
                                <li><a data-toggle="tab" href="#menu2">Apple Touch Images</a></li>
                                <li><a data-toggle="tab" href="#menu3">Microsoft Tile Images</a></li>
                            </ul>
