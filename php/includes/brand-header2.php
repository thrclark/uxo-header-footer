...
<div id="branding-bar" itemscope="itemscope" itemtype="http://schema.org/CollegeOrUniversity" role="complementary" aria-labelledby="iu-campus">
    <div class="container">
        <div class="row pad"> <img src="//assets.iu.edu/brand/2.x/trident-large.jpg" alt="IU">
            <p id="iu-campus"> <a href="http://www.iu.edu" title="Indiana University" class="external" aria-describedby="Indiana University home page"> <span class="show-on-desktop" itemprop="name">Indiana University</span> <span class="show-on-tablet" itemprop="name">Indiana University</span> <span class="show-on-mobile" itemprop="name">Indiana University</span> </a> </p>
        </div>
    </div>
</div>
