...
<div class="main-content container" role="main">
    <div id="main-content">
        ...
        <form>
            ...
            <div class="row">
                <div class="col-md-12 text-center" style="padding-bottom:15px; padding-top:15px;"> <a href="#" class="btn btn-lg btn-primary" data-toggle="modal" data-target="#verify_error" > Submit and Continue</a> </div>
            </div>
        </form>
    </div>
</div>
