                                ...
                                <form role="form">
                                    ...
                                    <div class="row setup-content" id="step-2">
                                        <div class="col-xs-12">
                                            ...
                                            <div class="panel-group" id="accordion-data">
                                                <div class="panel panel-default template-add-data">
                                                    <div class="panel-heading">
                                                        <p class="panel-title"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion-data" href="#data_panel1"> Section 1 </a> </p>
                                                    </div>
                                                    <div id="data_panel1" class="panel-collapse collapse in">
                                            ...
                                            <button class="btn btn-xs btn-default btn-add-panel1 pull-right"> <i class="icon-plus-2"></i>section</button>
                                            ...
                                            <div class="panel-group" id="accordion-group">
                                                <div class="panel panel-default template-add-group">
                                                    <div class="panel-heading">
                                                        <p class="panel-title"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion-group" href="#group_panel1"> Section 1 </a> </p>
                                                    </div>
                                                    <div id="group_panel1" class="panel-collapse collapse in">
                                                        <div class="panel-body">
                                                           sdfgsdfg sdfg sdfg sdfg sdgf sdfg 
                                                         </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <button class="btn btn-xs btn-default btn-add-panel2 pull-right"> <i class="icon-plus-2"></i>section</button>
                                            <br>
                                            <br>
                                            <br>
                                            <br>
...
<script type='text/javascript'>
    ...
    $(window).load(function() {
        ...
        $(".btn-add-panel2").on("click", function() {
            var $newPanelData = $template.clone();
            $newPanelData.find(".collapse").removeClass("in");
            $newPanelData.find(".accordion-toggle").attr("href", "#group_panel" + (++hash))
                .text("Section " + hash);
            $newPanelData.find(".panel-collapse").attr("id", hash).addClass("collapse").removeClass("in");
            $newPanelData.find(".panel-heading").append("<span class='pull-right'><i class='icon-cancel-2 clickable'></i></span>");
            $("#accordion-group").append($newPanelData.fadeIn());
            $(document).on('click', '.icon-cancel-2', function() {
                $(this).parents('.panel').get(0).remove();
            });
        });
