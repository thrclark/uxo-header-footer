                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            </select> <div class="validation-fieldmessage" style="display:none" id="val_auth"> <i class="fa fa-minus-circle" aria-hidden="true"></i> Please select an authentication type.</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ">
